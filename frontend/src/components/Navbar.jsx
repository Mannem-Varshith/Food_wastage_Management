    ...
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='hidden md:flex items-start gap-5 font-medium '>
        <NavLink to='/'>
          ...
          <hr className='border-none outline-node h-0.5 bg-primary w-3/5 m-auto hidden' />
        </NavLink>
        <NavLink to='/doctors'>
        ...
        <NavLink to="/receiver">
  <button className="bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded shadow ml-30">
    Receiver
  </button>
</NavLink>
